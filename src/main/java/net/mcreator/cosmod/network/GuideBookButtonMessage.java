...
import net.mcreator.cosmod.procedures.ButtonNoiseProcedure;
...
public class GuideBookButtonMessage {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 0) {
			...
			ButtonNoiseProcedure.execute(entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		CosmodMod.addNetworkMessage(GuideBookButtonMessage.class, GuideBookButtonMessage::buffer, GuideBookButtonMessage::new,
				GuideBookButtonMessage::handler);
	}
}
