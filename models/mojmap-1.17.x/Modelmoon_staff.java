...
public class Modelmoon_staff<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "moon_staff"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition staff = partdefinition.addOrReplaceChild("staff",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-8.0F, -9.0F, 7.0F, 1.0F, 25.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(11, 1)
		...
		PartDefinition moon = partdefinition.addOrReplaceChild("moon", CubeListBuilder.create().texOffs(4, 0)
				.addBox(-1.0F, -10.0F, -2.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
