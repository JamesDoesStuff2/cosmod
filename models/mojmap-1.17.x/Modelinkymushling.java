...
public class Modelinkymushling<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "inkymushling"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition rightfoot = partdefinition.addOrReplaceChild("rightfoot", CubeListBuilder.create().texOffs(0, 18)
				.addBox(-5.0F, 0.0F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(2.0F, 23.0F, 0.0F));

		PartDefinition leftfoot = partdefinition.addOrReplaceChild("leftfoot", CubeListBuilder.create().texOffs(0, 15)
				.addBox(3.0F, 0.0F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-2.0F, 23.0F, 0.0F));

		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(32, 27)
						.addBox(-3.0F, -4.0F, -3.0F, 6.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(0, 15)
						.addBox(-5.0F, -9.0F, -5.0F, 10.0F, 2.0F, 10.0F, new CubeDeformation(0.0F)).texOffs(30, 15)
						.addBox(-4.0F, -10.0F, -4.0F, 8.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-6.0F, -7.0F, -6.0F, 12.0F, 3.0F, 12.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bone = head.addOrReplaceChild("bone",
				CubeListBuilder.create().texOffs(2, 27)
						.addBox(5.0F, -5.0F, -6.0F, 1.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(4, 30)
		...
		PartDefinition bone2 = head.addOrReplaceChild("bone2",
				CubeListBuilder.create().texOffs(28, 26)
						.addBox(-6.0F, -5.0F, -6.0F, 0.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(2, 20)
		...
		PartDefinition bone3 = head.addOrReplaceChild("bone3",
				CubeListBuilder.create().texOffs(10, 10)
						.addBox(-6.0F, -5.0F, -6.0F, 0.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 20)
		...
		PartDefinition bone4 = head.addOrReplaceChild("bone4",
				CubeListBuilder.create().texOffs(8, 20)
						.addBox(5.0F, -5.0F, -6.0F, 1.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(6, 0)
		...
		PartDefinition cube_r1 = leftarm
				.addOrReplaceChild("cube_r1",
						CubeListBuilder.create().texOffs(0, 0).addBox(5.0F, -3.0F, -1.0F, 2.0F, 4.0F, 2.0F,
		...
		PartDefinition cube_r2 = rightarm
				.addOrReplaceChild("cube_r2",
						CubeListBuilder.create().texOffs(0, 6).addBox(-7.0F, -3.0F, -1.0F, 2.0F, 4.0F, 2.0F,
								new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r3 = body
				.addOrReplaceChild("cube_r3",
						CubeListBuilder.create().texOffs(0, 27).addBox(-4.0F, -7.0F, -4.0F, 8.0F, 6.0F, 8.0F,
								new CubeDeformation(0.0F)),
